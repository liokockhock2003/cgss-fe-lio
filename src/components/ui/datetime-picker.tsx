      ...
      <Popover open={open} onOpenChange={setOpen} modal={modal}>
        ...
        <PopoverContent className='w-auto p-2 space-y-2'>
          ...
          <div className='relative overflow-hidden'>
            ...
            />
            <div
              className={cn('absolute top-0 left-0 bottom-0 right-0', monthYearPicker ? 'bg-popover' : 'hidden')}></div>
            <MonthYearPicker
              value={month}
              mode={monthYearPicker as unknown as 'month' | 'year'}
