...
interface TableRowActionsProps {
  row: Row<TUserAccessGroupMap['main']['base']>
}

export function TableRowActions({ row }: TableRowActionsProps) {
  const canUpdate = true // useCan(({ permission: 'user-access-group-map.update' })
  const canDelete = true // useCan(({ permission: 'user-access-group-map.delete' })
