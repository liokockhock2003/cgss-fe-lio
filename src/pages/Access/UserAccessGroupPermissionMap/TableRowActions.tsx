...
interface TableRowActionsProps {
  row: Row<TUserAccessGroupPermissionMap['main']['base']>
}

export function TableRowActions({ row }: TableRowActionsProps) {
  const canUpdate = true // useCan(({ permission: 'user-access-group-permission-map.update' })
  const canDelete = true // useCan(({ permission: 'user-access-group-permission-map.delete' })
