...
interface TableRowActionsProps {
  row: Row<TUserGroupByMap['main']['base']>
}

export function TableRowActions({ row }: TableRowActionsProps) {
  const canUpdate = true // useCan(({ permission: 'user-group-by-map.update' })
  const canDelete = true // useCan(({ permission: 'user-group-by-map.delete' })
