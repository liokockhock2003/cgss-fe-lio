...
function EndOfLifeTreatmentOfSoldProductsPage() {
  return (
...
EndOfLifeTreatmentOfSoldProductsPage.displayName = 'EndOfLifeTreatmentOfSoldProductsPage'
export const Component = EndOfLifeTreatmentOfSoldProductsPage
