...
function ProcessingOfSoldProductsPage() {
  return (
...
ProcessingOfSoldProductsPage.displayName = 'ProcessingOfSoldProductsPage'
export const Component = ProcessingOfSoldProductsPage
