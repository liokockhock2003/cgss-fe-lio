...
function PurchasedGoodsAndServicesPage() {
  return (
...
PurchasedGoodsAndServicesPage.displayName = 'PurchasedGoodsAndServicesPage'
export const Component = PurchasedGoodsAndServicesPage
